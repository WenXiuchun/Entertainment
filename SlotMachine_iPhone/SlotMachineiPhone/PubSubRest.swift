...
class PubSubRest: NSObject{
    ...
    func getEvents() {
        ...
        // {
        //    "metadata": { "version": "1" },
        //    "payload": "{ \"appleID\": \"3889B95E-E3AE-4A94-835F-A6E165257755\", \"username\": \"3889B95E-E3AE-4A94-835F-A6E165257755\", \"emotion\": \"happines\",\"gameResultWin\": \"true\" }"
        // }
        ...
        let task = session.dataTaskWithRequest(request, completionHandler: {data, response, error -> Void in
            ...
            if (httpResponse!.statusCode == 401) {
                ...
                if (json != nil) {
                    ...
                    do{
                        let task_commit = session.dataTaskWithRequest(request, completionHandler: {data, response, error -> Void in
                            
                            let httpResponse2 = response as? NSHTTPURLResponse
                            let json2:JSON = JSON(data: data!)
                        })
                        task_commit.resume()
                    }
